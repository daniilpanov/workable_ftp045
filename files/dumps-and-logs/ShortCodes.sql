...
INSERT INTO `reviews` (`id`, `page`, `author`, `email`, `content`, `rating`, `visible`, `created`, `mods`) VALUES (1,3,'Author 1','example@mail.ru','It&acute;s a good production',8,'1',10,'');
...
-- Dump completed on 2020-02-13 17:45:01
